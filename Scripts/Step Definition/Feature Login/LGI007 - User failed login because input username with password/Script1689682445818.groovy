...
WebUI.callTestCase(findTestCase('Pages/01_User_Login/Input Username'), [('username') : 'secret_sauce'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/01_User_Login/Input Password'), [('password') : 'standard_user'], FailureHandling.STOP_ON_FAILURE)
