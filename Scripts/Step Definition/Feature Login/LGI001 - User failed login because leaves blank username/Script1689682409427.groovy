...
WebUI.callTestCase(findTestCase('Pages/01_User_Login/Input Password'), [('password') : 'secret_sauce'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/01_User_Login/Tap Login'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/01_User_Login/Read Error Message'), [('expected') : 'Username is required'], FailureHandling.STOP_ON_FAILURE)
